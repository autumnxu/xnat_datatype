...
import org.nrg.xdat.bean.HemorrhageBiomarkerTableBean;
...
@XnatPlugin(value = "workshopPlugin", name = "XNAT 1.7 Workshop 2016 Plugin", entityPackages = "org.nrg.xnat.workshop.entities",
            dataModels = {@XnatDataModel(value = HemorrhageBiomarkerTableBean.SCHEMA_ELEMENT_NAME,
                                         singular = "Hemorrhage Biomarker Table", // Biosample Collection
                                         plural = "Hemorrhage Biomarker Tables"),
